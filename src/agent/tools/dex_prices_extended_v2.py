...
from .dex_prices_v2 import get_token_decimals
    ...
    try:
        ...
        if best_price > 0:
            ...
            try:
                ...
                if to_token.upper() == "ETH":
                    to_addr = "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"
...
def get_all_dex_prices_extended(from_token: str, to_token: str) -> str:
    ...
    from .dex_prices_v2 import get_sushiswap_price, get_uniswap_v3_price
