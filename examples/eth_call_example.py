...
def example_test_swap():
    ...
    # Give user 100 WETH
    weth_slot = w3.solidity_keccak(['address', 'uint256'], [user_address, 3])  # WETH uses slot 3
    ...
    print(f"- User will have 100 WETH")
    print(f"- User will have 10 ETH for gas")
